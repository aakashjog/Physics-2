...
\begin{align*}
	\dif \Phi_B & = \Phi_B(t + \dif t) - \Phi_B(t)                                                                                                  \\
                    & = \left( \text{flux due to common area} + B_2 L v \dif t \right) - \left( \text{flux due to common area} + B_1 L v \dif t \right) \\
...
\begin{law}[Lenz's Law]
	The direction of an induced current is in a direction such that it opposed the change in the magnetic flux responsible for its creation.
	\label{Lenz's Law}
\end{law}
