\documentclass[fleqn, a4paper, 10pt, oneside]{scrartcl}
...
\usepackage[urw-garamond]{mathdesign}% Use the Adobe Utopia font for the document - comment this line to return to the LaTeX default
%\usepackage{calligra}
...
{	
	...
	\huge Physics 2 : Assignment 3 \\ % The assignment title
